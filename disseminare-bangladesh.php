...
<?php
$sql_content1 = "SELECT * FROM `page` WHERE `alias` = 'disseminarebangladesh' and status = '0'";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="course_all">
                <div class="float-right"><a href="http://disseminare.com/newsite/page/past-assignment" class="theme-btn">Past Assignments</a></div>
                <?php
