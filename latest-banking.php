...
<?php
$sql_content1 = "SELECT * FROM `page` WHERE `alias` = 'latest-banking' and status = '0'";
            ...
            <div class="col-lg-12">
                <div class="about-left-content">
                    ...
                    <div class="text-center">
                        ...
                        <embed onmousedown="disableRightclick()" id="stopRightclick" src="<?php echo $base_url . $document_path_upload_media; ?>23-11-18_1542954510.pdf#toolbar=0" width="800" height="575">
                    </div>
                </div>
            </div>
