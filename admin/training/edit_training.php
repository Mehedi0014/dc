                    ...
                    <div class="panel-body">
                        <div id="Edit_collegeInfo_form" class="row">
                            <div class="col-md-12">
                                 ...
                                 */
                                $get_cms_qry = "SELECT * FROM `training` WHERE `id` = '$id'";
                                $res = mysqli_query($con, $get_cms_qry) or trigger_error("Query Failed! SQL: $get_cms_qry - Error: " . mysqli_error(), E_USER_ERROR);

                                $row = mysqli_fetch_assoc($res);
                                ?>
                                <form class="form-horizontal" name="edit_collegeCMS" id="edit_collegeCMS" method="post" action="db_edit_training.php" enctype="multipart/form-data">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body"> 
                                            <div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">Training Name</label>
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="training_name" class="form-control" id="dept_name" value="<?php echo $row['name']; ?>" required/>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">F Icon</label>
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="ficon" class="form-control" id="dept_name" value="<?php echo $row['f_icon']; ?>"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="<?php echo $base_url . $document_path_training . $row['banner_img']; ?>" width="400px"  />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="<?php echo $base_url . $document_path_training . $row['homepage_image']; ?>" width="400px"  />
        <!--                                                        <br><span>Image Size 2600 x 500</span>-->
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">Training Image</label>
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="file" name="training_image" id="college_logo" class="form-control"/>
                                                        <img src="<?php echo $base_url . $document_path_training . $row['other_image']; ?>" width="400px"  />
        <!--                                                        <br><span>Image Size 2600 x 500</span>-->
                                                    </div>
                                                </div>
                                            </div>
