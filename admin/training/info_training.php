        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="Add_collegeInfo_form" class="row" style="display: none;">
                    <div class="col-md-12">
                        <form class="form-horizontal" name="add_collegeCMS" id="add_collegeCMS" method="post" action="db_add_training.php" enctype="multipart/form-data">
                                ...
                                <div class="panel-body"> 
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="training_name" class="form-control" id="dept_name" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="ficon" class="form-control" id="dept_name"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
        ...
        <!--                                                <span>Image Size 1200 x 226</span>-->
            ...
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">List Of Trainings</h3>
                    <?php
                ...
                <div class="panel-body">
                    <table class="table dataTable table-bordered table-hover table-responsive">
                        ...
                        <tbody style="font-size: 11px">
                            ...
                            $qry_tbl = "SELECT * FROM `training` ORDER BY `sort`";
                            ...
                            while ($row_tbl = mysqli_fetch_assoc($res_tbl)) {
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td>
                                        <a href="edit_training.php?id=<?php echo $row_tbl['id']; ?>&action=Edit" ><span class="fa fa-pencil text-primary"></span></a>
                                    </td>
            ...
            <div class="btn btn-primary" onclick="ShowContainer('Add_collegeInfo_form')"><span class="fa fa-plus"></span>Add Trainings here</div>
            <div>&nbsp;</div>
        </div>
