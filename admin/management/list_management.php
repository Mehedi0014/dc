        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div id="Add_collegeInfo_form" class="row" style="display: none;">
                    <div class="col-md-12">
                        <form class="form-horizontal" name="add_collegeCMS" id="add_collegeCMS" method="post" action="db_add_management.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="management_title" class="form-control" id="page_title" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="designation" class="form-control" id="page_title" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">Management Team</h3>
                    <?php
...
//                                include("includes/conn.php");
                            $qry_artc = "SELECT * FROM `management`";
                            ...
                            while ($row_artc = mysqli_fetch_assoc($res_artc)) {
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td>
                                        <a href="edit_management.php?id=<?php echo $row_artc['id']; ?>&action=Edit" ><span class="fa fa-pencil text-primary">&nbsp;</span>Edit</a>
                                    </td>  
            ...
            <div class="btn btn-primary" onclick="ShowContainer('Add_collegeInfo_form')"><span class="fa fa-plus"></span>Add Management Team here</div>
            <div>&nbsp;</div>
        </div>
        </div>
