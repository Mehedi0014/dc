        ...
        <div class="row">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body"> 
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Image Label</label>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">   
                    <?php
                    $qry_cat = "select * from gallery_category where id = '$cat_id'";
                    ...
                    ?>
                    <h3 class="panel-title">Image List of Category <?php echo $row_cat['category_name']; ?></h3>
                    <?php
                ...
                <div class="panel-body">
                    <table class="table dataTable table-bordered table-hover table-responsive">
                        ...
                        <tbody style="font-size: 11px" id="sortThis">
                            ...
                            $qry_tbl = "SELECT * FROM `gallery` where category_id = '$cat_id' ORDER BY `sort`";
                            ...
                            while ($row_tbl = mysqli_fetch_assoc($res_tbl)) {
                                ...
                                <tr id="<?php echo $row_tbl['id']; ?>" >
                                    ...
                                    <td class="text-left"><?php echo strtoupper($row_tbl['gallery_title']) ?></td>

                                    <td class="text-left">
                                        <img src="<?php echo $base_url . $document_path_gallery . $row_tbl['gallery_img']; ?>" height="50px" width="50px">
                                    </td>
