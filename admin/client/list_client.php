        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div id="Add_collegeInfo_form" class="row" style="display: none;">
                    <div class="col-md-12">
                        <form class="form-horizontal" name="add_collegeCMS" id="add_collegeCMS" method="post" action="db_add_client.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="client_name" class="form-control" id="page_title" required/>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Client Logo</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
        ...
        <!--                                                <span>Image Size 1200 x 226</span>-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="sort" class="form-control" id="page_title" required/>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">List Client</h3>
                    <?php
...
//                                include("includes/conn.php");
                            $qry_artc = "SELECT * FROM `client` order by sort";
                            ...
                            while ($row_artc = mysqli_fetch_assoc($res_artc)) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><img src="<?php echo $base_url . $document_path_client . $row_artc['logo']; ?>" style="height: 100px; width: 100px;"></td>
                                    <td class="text-left"><?php echo $row_artc['sort']; ?></td>
                                    <td>
                                        <a href="edit_client.php?id=<?php echo $row_artc['id']; ?>&action=Edit" ><span class="fa fa-pencil text-primary">&nbsp;</span>Edit</a>
                                    </td>  
                                    <td>
                                        <a href="delet_client.php?id=<?php echo $row_artc['id']; ?>&action=Edit" ><span class="fa fa-pencil text-primary">&nbsp;</span>Delete</a>
                                    </td> 
                                </tr>
                                <?php
                                $i++;
            ...
            <div class="btn btn-primary" onclick="ShowContainer('Add_collegeInfo_form')"><span class="fa fa-plus"></span>Add Client here</div>
            <div>&nbsp;</div>
        </div>
        </div>
