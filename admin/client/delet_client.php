...
$qry_sel_file = "select * from `client` WHERE `id`= '$id'";
...
if ($res) {
    unlink($document_path . $row_sel_file['logo']);
    header("Location: list_client.php?insertmsg=Deleted");
} else {
    header("Location: list_client.php?=faliure");
}
//}
