                    ...
                    <div class="panel-body">
                        <div id="Edit_collegeInfo_form" class="row">
                            <div class="col-md-12">
                                 ...
                                 */
                                $get_cms_qry = "SELECT * FROM `course` WHERE `id` = '$id'";
                                $res = mysqli_query($con, $get_cms_qry) or trigger_error("Query Failed! SQL: $get_cms_qry - Error: " . mysqli_error(), E_USER_ERROR);

                                $row = mysqli_fetch_assoc($res);
                                ?>
                                <form class="form-horizontal" name="edit_collegeCMS" id="edit_collegeCMS" method="post" action="db_edit_course.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="course_name" class="form-control" id="dept_name" value="<?php echo $row['name']; ?>" required/>
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="editor2" id="editor1" rows="10" cols="80">
                                                            <?php echo isset($row['short_description']) ? htmlspecialchars_decode($row['short_description']) : ''; ?>  
                                                        </textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="<?php echo $base_url . $document_path_course . $row['banner_img']; ?>" width="400px"  />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="<?php echo $base_url . $document_path_course . $row['homepage_image']; ?>" width="400px"  />
        <!--                                                        <br><span>Image Size 2600 x 500</span>-->
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="course_date" value="<?php echo $row['course_date']; ?>" class="form-control datepicker" readonly required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="number" name="fee" class="form-control" id="dept_name" value="<?php echo $row['course_fee']; ?>" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="seat" class="form-control" id="dept_name" value="<?php echo $row['seat']; ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
