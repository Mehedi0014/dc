                    ...
                    <div class="panel-body">
                        <div id="Edit_collegeInfo_form" class="row">
                            <div class="col-md-12">
                                 ...
                                 */
                                $get_cms_qry = "SELECT * FROM `service_images` WHERE `id` = '$id'";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="title" class="form-control" id="dept_name" value="<?php echo $row['name']; ?>" required/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="<?php echo $base_url . $document_path_service . $row['image']; ?>" width="205" height="200" />
                                                    </div>
                                                </div>
                                            </div>  
