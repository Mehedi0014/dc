                        ...
                        <form class="form-horizontal" name="add_collegeCMS" id="add_collegeCMS" method="post" action="db_add_page.php" enctype="multipart/form-data">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body"> 
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Text</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="text" class="form-control" id="page_title" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
//                                include("includes/conn.php");
                            $qry_artc = "SELECT * FROM `innerpage_banner`";
                            ...
                            while ($row_artc = mysqli_fetch_assoc($res_artc)) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo strtoupper($row_artc['page_name']); ?></td>
                                    <td class="text-left"><?php echo $row_artc['text']; ?></td>
                                    <td>
                                        <a href="edit_banner.php?id=<?php echo $row_artc['id']; ?>&action=Edit" ><span class="fa fa-pencil text-primary">&nbsp;</span>Edit</a>
                                    </td>  
