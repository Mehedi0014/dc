        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">Edit Reviews</h3>
                    <?php
                ...
                <div class="panel-body">
                    <div id="Edit_collegeInfo_form" class="row">
                        <div class="col-md-12">
                            <?php
                            /**
                             * Getting CMS content for Posts to edit
                             */
                            $get_cms_qry = "SELECT * FROM `testimonial` WHERE `id` = '$id'";
                            $res = mysqli_query($con, $get_cms_qry) or trigger_error("Query Failed! SQL: $get_cms_qry - Error: " . mysqli_error(), E_USER_ERROR);

                            $row = mysqli_fetch_assoc($res);
                            ?>

                            <form class="form-horizontal" name="edit_collegeCMS" id="edit_collegeCMS" method="post" action="db_edit_testimonial.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="tes_name" class="form-control" id="menu_label" value="<?php echo $row['name']; ?>" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                    <input type="text" name="desg" class="form-control" id="menu_label" value="<?php echo $row['designation']; ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="input-group">
                                                    ...
                                                    <img src="<?php echo $base_url . $document_path_testimonial . $row['image']; ?>" width="400px"  />
