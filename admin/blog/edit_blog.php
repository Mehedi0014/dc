...
if (isset($_SESSION['user_role']) || $_SESSION['user_role'] != '') {
    ...
    if ($user == '0') {
        ...
        $qry_artc = "SELECT * FROM `blog` WHERE `id`= '$artc_id'";
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div id="edit_cms_form" class="row" >
                            <div class="col-md-12">
                                <form class="form-horizontal" name="editCMS" id="editCMS" method="post" action="db_edit_blog.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="<?php echo $base_url . $document_page_blog . $row_artc['banner_img']; ?>" width="400px"  />
        <!--                                                        <br><span>Image Size 2600 x 500</span>-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="blog_date" class="form-control" id="page_title" value="<?php echo isset($row_artc['blog_date']) ? $row_artc['blog_date'] : ''; ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
