...
$spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(9, 1, 'CV url');
$spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(10, 1, 'Date Applied');
...
while ($row_data = mysqli_fetch_array($res_data)) {
    ...
    $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(10, $row_next, $row_data['date']);
