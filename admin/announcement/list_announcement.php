        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div id="Add_collegeInfo_form" class="row" style="display: none;">
                    <div class="col-md-12">
                        <form class="form-horizontal" name="add_collegeCMS" id="add_collegeCMS" method="post" action="db_add_announcement.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="page_title" required/>
                                            </div>
                                        </div>
                                    </div>
...
//                                include("includes/conn.php");
                            $qry_artc = "SELECT * FROM `announcement` order by sort";
                            ...
                            while ($row_artc = mysqli_fetch_assoc($res_artc)) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                            <img src="<?php echo $base_url . $document_path_announcement . $row_artc['image'] ?>" style="height: 150px; width: 150px;">
                                    ...
                                    <?php } ?>
                                    <td>
                                        <a href="edit_announcement.php?id=<?php echo $row_artc['id']; ?>&action=Edit" ><span class="fa fa-pencil text-primary">&nbsp;</span>Edit</a>
                                    </td>
                                    <td>
                                        <a href="delete_announcement.php?id=<?php echo $row_artc['id']; ?>&action=Edit" ><span class="fa fa-trash-o text-primary">&nbsp;</span>Delete</a>
                                    </td>  
            ...
            <div class="btn btn-primary" onclick="ShowContainer('Add_collegeInfo_form')"><span class="fa fa-plus"></span>Add Announcement Here</div>
            <div>&nbsp;</div>
        </div>
        </div>
