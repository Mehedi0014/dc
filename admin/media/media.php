        ...
        <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="med_title" class="form-control" id="page_title"/>
                                                <input type="hidden" name="dept" class="form-control" id="page_title" value="0"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="file" name="med_file" id="college_logo" class="form-control" required/>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">List Media</h3>
                    <?php
...
//                                include("includes/conn.php");
                            ...
                            while ($row_artc = mysqli_fetch_assoc($res_artc)) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <?php
                                        echo $base_url . $document_path_upload_media . $row_artc['file'];
                                        ?>
                                    </td>
            ...
            <div class="btn btn-primary" onclick="ShowContainer('Add_collegeInfo_form')"><span class="fa fa-plus"></span>Add Media here</div>
            <div>&nbsp;</div>
        </div>
        </div>
