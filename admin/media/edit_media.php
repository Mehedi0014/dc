...
if (isset($_SESSION['user_role']) || $_SESSION['user_role'] != '') {
    ...
    if ($user == '0') {
        ...
        $qry_artc = "SELECT * FROM `media` WHERE `id`= '$id'";
                                        ...
                                        <div class="panel-body"> 
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="med_title" class="form-control" id="page_title" value="<?php echo isset($row_artc['title']) ? $row_artc['title'] : ''; ?>"/>
                                                        <input type="hidden" name="dept" class="form-control" id="page_title" value="<?php echo $row_artc['uploaded_by']; ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="file" name="med_file" id="college_logo" class="form-control"/>
